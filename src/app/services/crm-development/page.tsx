                    ...
                    <div className="lg:col-span-2 space-y-2">
                        {features.map((feature, index) => (
                            <motion.button
                                ...
                                className={`w-full flex items-center gap-4 p-4 rounded-xl text-left transition-all ${activeTab === index
                                    ? "bg-[#00adef] text-white"
                                    : "bg-white text-[#0e1012] hover:bg-gray-100 border border-gray-200"
                                    }`}
                            >
                                <div className={`w-12 h-12 rounded-lg flex items-center justify-center ${activeTab === index ? "bg-white/20" : "bg-[#00adef]/10"
                                    }`}>
                                ...
                                <ChevronRight className={`w-5 h-5 ml-auto transition-transform ${activeTab === index ? "rotate-90" : ""}`} />
                            </motion.button>
                        ))}
                    </div>
