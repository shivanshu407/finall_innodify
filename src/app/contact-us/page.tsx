                        ...
                        <form onSubmit={handleSubmit} className="bg-[#f8f8f8] rounded-2xl p-8">
                            <div className="grid md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <input
                                        ...
                                        className="w-full px-4 py-3 rounded-lg border border-gray-200 focus:border-[#00adef] focus:ring-2 focus:ring-[#00adef]/20 outline-none transition-all"
                            ...
                            <div className="mt-6">
                                ...
                                <textarea
                                    ...
                                    onChange={handleChange}
                                    className="w-full px-4 py-3 rounded-lg border border-gray-200 focus:border-[#00adef] focus:ring-2 focus:ring-[#00adef]/20 outline-none transition-all resize-none"
                            ...
                            <button
                                type="submit"
                                className="mt-6 w-full flex items-center justify-center gap-2 px-8 py-4 bg-[#00adef] text-[#0e1012] font-semibold rounded-lg hover:bg-[#00adef]/90 transition-colors"
                            >
                                Send Message
                                <Send size={18} />
                            </button>
    ...
    const faqs = [
        {
            ...
            answer: "Timeline varies based on complexity. A standard Shopify store takes 4-6 weeks, while enterprise Magento projects may take 3-6 months.",
        },
        {
            question: "Do you offer ongoing support?",
            answer: "Yes! We offer maintenance and support packages to keep your store running smoothly after launch.",
        },
        {
            question: "What's your pricing model?",
            answer: "We offer both fixed-price projects and retainer-based engagements depending on your needs.",
        },
    ];
