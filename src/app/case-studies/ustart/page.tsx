...
export default function UstartCaseStudy() {
    return (
        <div className="min-h-screen bg-white">
            {/* Hero Section */}
            <section className="bg-[#0e1012] pt-32 pb-20 relative overflow-hidden">
                <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1549313861-3365b9d316e6?w=1600&q=80')] bg-cover bg-center opacity-20" />
                        ...
                        >
                            <div>
                                <div className="text-3xl font-bold text-white flex items-center gap-2">
                                    <Smartphone size={24} /> React Native
                                </div>
                                <div className="text-sm text-gray-400 mt-1">Core Framework</div>
                            </div>
                            <div>
                                <div className="text-3xl font-bold text-white flex items-center gap-2">
                                    <Zap size={24} /> Expo
                                </div>
                                <div className="text-sm text-gray-400 mt-1">App Infrastructure</div>
                            </div>
                            <div>
                                <div className="text-3xl font-bold text-white">Native</div>
                                <div className="text-sm text-gray-400 mt-1">Modules Integration</div>
                            </div>
                            <div>
                                <div className="text-3xl font-bold text-white">0%</div>
                                <div className="text-sm text-gray-400 mt-1">Commission Model</div>
                            </div>
                        </motion.div>
                    </div>
                </div>
                            ...
                            <ul className="space-y-4">
                                <li className="flex gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-gray-600 mt-1">Map rendering and socket connections needed to be flawless without battery drain.</p>
                                    </div>
                                </li>
                                <li className="flex gap-3">
                                    <div className="mt-1 w-6 h-6 bg-[#00adef]/20 rounded-full flex items-center justify-center flex-shrink-0">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-gray-600 mt-1">Direct access to underlying OS APIs to ensure reliable background location tracking.</p>
                                    </div>
                                </li>
                                <li className="flex gap-3">
                                    <div className="mt-1 w-6 h-6 bg-[#00adef]/20 rounded-full flex items-center justify-center flex-shrink-0">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-gray-600 mt-1">A bespoke, frictionless interface designed for split-second decisions by drivers and riders.</p>
                                    </div>
                                </li>
                            </ul>
                        </motion.div>
                        ...
                        {[
                            {
                                ...
                                description: "Handled heavy computational tasks using native functions bridged to React Native for zero-lag map interactions and background threading."
                            },
                            {
                                icon: Zap,
                                title: "Expo Infrastructure",
                                description: "Utilized the Expo ecosystem for rapid deployment and continuous over-the-air updates without sacrificing bare-metal performance."
                            },
                            {
                                icon: Smartphone,
                                title: "Cleaner App State",
                                description: "Implemented a highly optimized global state management system ensuring instant UI updates for driver matching and ride status."
                            }
                        ].map((item, index) => (
                            <motion.div
                                key={item.title}
