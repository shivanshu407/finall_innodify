                        ...
                        >
                            <Link href={service.href}>
                                <div className="bg-white rounded-2xl overflow-hidden border border-gray-200 hover:shadow-xl transition-all duration-500">
                                    {/* Image area */}
                                    <div className={`h-40 relative transition-colors duration-500 ${hoveredIndex === index ? "bg-amber-500" : "bg-gradient-to-br from-gray-100 to-gray-200"
                                        }`}>
                                        <div className="absolute inset-0 flex items-center justify-center">
                                            <service.icon className={`w-16 h-16 transition-colors duration-500 ${hoveredIndex === index ? "text-white" : "text-gray-400"
                                                }`} />
                                        </div>
                                    </div>
