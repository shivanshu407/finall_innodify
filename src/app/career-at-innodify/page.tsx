            ...
            <div className="container mx-auto px-6 relative z-10">
                ...
                >
                    ...
                    <p className="mt-6 text-lg text-gray-300">
                        We're a team of passionate eCommerce experts looking for talented individuals
                        who want to make an impact. Join us!
                    </p>
                </motion.div>
            </div>
        </section>
            ...
            <div className="container mx-auto px-6">
                ...
                >
                    ...
                    <p className="mt-4 text-gray-600 max-w-2xl mx-auto">
                        We believe happy people do their best work. Here's what we offer.
                    </p>
                </motion.div>
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {perks.map((perk, index) => (
                        <motion.div
                            ...
                            className="flex items-start gap-4 p-6 bg-[#f8f8f8] rounded-xl hover:bg-white hover:shadow-xl transition-all"
                        >
                            <div className="w-12 h-12 rounded-lg bg-[#00adef]/10 flex items-center justify-center flex-shrink-0 text-[#00adef]">
                                {perk.icon}
                            </div>
                            <div>
        ...
        <section className="py-24 bg-[#f8f8f8]">
            <div className="container mx-auto px-6">
                ...
                <div className="space-y-4">
                    {positions.map((position, index) => (
                        <motion.div
                            ...
                            className="bg-white rounded-xl p-6 hover:shadow-xl transition-shadow cursor-pointer group"
                        >
                            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                                <div>
                                    <h3 className="text-lg font-semibold text-[#0e1012] group-hover:text-[#00adef] transition-colors">
                                        {position.title}
                                    </h3>
                ...
                >
                    ...
                    <a
                        href="/contact-us"
                        className="mt-4 inline-flex items-center gap-2 text-[#00adef] font-medium hover:underline"
                    >
                        Send us your resume
                        <ArrowRight size={16} />
                    </a>
                    ...
                    <div className="mt-12 grid md:grid-cols-3 gap-8">
                        <div className="text-center">
                            ...
                            <p className="mt-3 text-gray-400">
                                We measure success by the value we create, not the hours we clock.
                            </p>
                        </div>
                        <div className="text-center">
                            <h3 className="text-xl font-semibold text-[#00adef]">Continuous Learning</h3>
                            <p className="mt-3 text-gray-400">
                                eCommerce evolves fast. We stay curious and keep growing.
                            </p>
                        </div>
                        <div className="text-center">
                            <h3 className="text-xl font-semibold text-[#00adef]">Own Your Work</h3>
                            <p className="mt-3 text-gray-400">
                                We trust each team member to take ownership and deliver excellence.
                            </p>
                        </div>
                    </div>
                </motion.div>
